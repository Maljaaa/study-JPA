...
단적인 예로, 페이징 처리는 DB마다 달라서 사용법을 각각 배워야 한다.  
결국 애플리케이션은 처음 선택한 DB 기술에 종속되고 다른 DB로 변경하기엔 어렵다.  
  
하지만 JPA를 사용하면 애플리케이션과 DB 사이에 추상화된 데이터 접근 계층을 제공해서 특정 DB 기술에 종속되지 않도록 한다.  
![벤더 독립성](https://images.velog.io/images/yu-jin-song/post/dcaeda65-3fed-4973-bf89-73e1274b85f3/%EB%B2%A4%EB%8D%94_%EB%8F%85%EB%A6%BD%EC%84%B1.png)
  
6. 표준  
JPA는 자바 진영의 ORM 기술 표준이므로 다른 구현 기술로 손쉽게 **변경**할 수 있다.  
